...
// var key = req.query.x-key;
    ...
    console.log(token);
    console.log(key);
    console.log('organisation invoked');
    if (token || key) {
        try {
...
//                        }
//                        else {
                            if ((req.url.indexOf('organisation') >= 0 && rows[0].account_type == 'organisation') && rows[0].pending==0 && rows[0].is_active == 1| (req.url.indexOf('organisation') < 0 && req.url.indexOf('/api/organisation/') >= 0 && rows[0].pending==0 && rows[0].is_active == 1)) {
